 ...
 * Propel ORM Wrapper.
 */
class Propel extends AbstractStorage
{
    /**
     * @var object
     */
     ...
     */
    public function __construct(Jarves $jarves, Objects $objects, ACL $acl, ConditionOperator $conditionOperator)
    {
        $this->jarves = $jarves;
