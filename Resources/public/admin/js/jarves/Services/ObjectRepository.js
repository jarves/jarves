jarves.Services.ObjectRepository = new Class({
     ...
     */
    initialize: function($rootScope, $q, $injector, $timeout, backend, jarvesService) {
    ...
    onObjectChange: function(objectKey, cb) {
    ...
    fireObjectChange: function(objectKey) {
        if (this.changesCallback[objectKey]) {
    ...
    newCollection: function(objectKey) {
    ...
    loadItems: function(objectKey, entryPoint, queryOptions) {
        var deferred = this.$q.defer();
